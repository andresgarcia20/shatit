...
RSpec.describe "/trip_join_requests/:id/payment_in_progress", type: :request do
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested trip_payment_in_progress" do
    ...
    context "with invalid parameters" do
      it "renders a successful response (i.e. to display the 'edit' template)" do
        patch trip_payment_in_progress_url(trip_request, :trip_id => trip.id), params: { trip_join_request: invalid_attributes }
