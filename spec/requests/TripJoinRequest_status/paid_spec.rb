...
RSpec.describe "/trip_join_requests/:id/paid", type: :request do
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested trip_paid" do
        patch trip_paid_url(trip_request, :trip_id => trip.id), params: { trip_join_request: new_attributes }
        trip_request.reload
    ...
    context "with invalid parameters" do
      it "renders a successful response (i.e. to display the 'edit' template)" do
        patch trip_paid_url(trip_request, :trip_id => trip.id), params: { trip_join_request: invalid_attributes }
