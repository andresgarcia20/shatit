...
RSpec.describe "/trip_join_requests/:id/accepted", type: :request do
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested trip_accepted" do
        patch trip_accepted_url(trip_request, :trip_id => trip.id), params: { trip_join_request: new_attributes }
        trip_request.reload
    ...
    context "with invalid parameters" do
      it "renders a successful response (i.e. to display the 'edit' template)" do
        patch trip_accepted_url(trip_request, :trip_id => trip.id), params: { trip_join_request: invalid_attributes }
